import { DivCenterContent, StyledH3, StyledMainDiv, StyledClickable } from "./style"
...
export const MainDiv = () => {
    ...
    const { setShowOnlyFavCoins } = useContext(ExchangeContext) as Context
